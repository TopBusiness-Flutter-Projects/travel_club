                ...
                : SingleChildScrollView(
                    child: Column(children: [
                      ListView.builder(
                        ...
                        itemCount: cubit.entertainmentReservationModel.data!
                                .reservations?.length ??
                            0,
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, Routes.detailsBookingEntertainment,
                                    arguments: cubit
                                        .entertainmentReservationModel
                                        .data!
                                        .reservations![index]);
                              },
                              child: CustomBookingEntertainmentContainerBig(
                                entertainmentModel: EntertainmentModel(
                                    numofnights: cubit
                                        ...
                                        .process
                                        .toString(),
                                    price: cubit.entertainmentReservationModel
                                        .data!.reservations![index].totalPrice
                                        .toString(),
                                    title: cubit.entertainmentReservationModel
                                        .data!.reservations![index].wayService
                                        .toString(),
                                    date: cubit.entertainmentReservationModel
                                        .data!.reservations![index].date
                                        .toString(),
                                    rate: cubit.entertainmentReservationModel
                                        .data!.reservations![index].rate,

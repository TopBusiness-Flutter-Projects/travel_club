        ...
        builder: (context, state) {
          ...
          CustomTextField(
           ...
           // CustomHomeAppbar(isHome: false, title: AppTranslations.favorites,),
            Expanded(
              child: Column(
                ...
                children: [
                    ...
                    child: SizedBox(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return CustomBookingSectionSearch(index: index,);
                        },
                  ...
                  //body ...
                  if(cubit.categories[cubit.selectedIndex] ==     AppTranslations.accommodation)...[
                   // Container()
                    Expanded(
                  ...
                  if(cubit.categories[cubit.selectedIndex] == AppTranslations.transportation)...[
                    Expanded(
                        child: ListView.builder(
                            itemCount: 10,
                            itemBuilder: (context, index) => CustomCompanyContainer(isFavouriteScreen: false,))),
                  ],
                  if(cubit.categories[cubit.selectedIndex] ==AppTranslations.food)...[
                    ...
                    Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) =>   Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: BigContainerFood(index: 0,isFavouriteScreen: false,),
                          ) ,))
                        ...
                        itemBuilder: (context, index) {
                          return  Padding(
                            ...
                            child: GestureDetector(
                                ...
                                child: CustomContainerCompanies(isDetails: true,isFavouriteScreen: false,)
                            ),
                          );
                        } ,itemCount: 10,),
                    )
            ...
            SizedBox(height:getHeightSize(context)*.1,)
          ]);
        });
  }
}

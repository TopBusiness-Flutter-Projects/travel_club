          ...
          if(widget.isHome==true)...[
            ...
            Expanded(
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                cubit.loginModel.data==null?  Text(
                  //widget.title!,
                    AppConst.isLogged?AppTranslations.welcome+'..... ':'Guest',
                    style: getSemiBoldStyle(color: AppColors.blue, fontSize: 18.sp)):
                Text(
                    //widget.title!,
                  AppConst.isLogged?AppTranslations.welcome+' '+'${cubit.loginModel.data?.name}':'Guest',
                    style: getSemiBoldStyle(color: AppColors.blue, fontSize: 18.sp))
              ]),
            ),
          ]

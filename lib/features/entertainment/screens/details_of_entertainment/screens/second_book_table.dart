              ...
              child: SingleChildScrollView(
                child: Column(
                    ...
                    children: [
                      ...
                      CustomPricesWidget(
                        totalPrice:
                            "${cubit.addFoodReservationModel?.data?.totalPrice}",
                        totalPriceAfterVat:
                            "${cubit.addFoodReservationModel?.data?.totalPriceAfterVat}",
                        vat: "${cubit.addFoodReservationModel?.data?.vat}",
                        terms: cubit.getOrganizationsDetailsModel?.data?.rule,
                        reservationId: wayService.id ?? 0,
                      ),
                    ]),
              ),
            ));

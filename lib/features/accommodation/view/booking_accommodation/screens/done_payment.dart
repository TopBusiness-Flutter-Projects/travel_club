    ...
    return BlocBuilder<AccomendationCubit,AccomendationState>(builder: (BuildContext context, state) {  return  CustomScreen(
      ...
      body:Column(
        ...
        children: <Widget>[
          ...
          SizedBox(height: getHeightSize(context)/4,),
          //image
          Center(child: SvgPicture.asset(AppIcons.correctGreen)),
          SizedBox(height: 10.h,),
          //text
          Text(AppTranslations.bookingSuccess,style: getSemiBoldStyle(fontSize: 20.sp,color: AppColors.green,),),
          SizedBox(height: 20.h,),
          //message
          Text(AppTranslations.bookingSuccessMessage+'${917897291}',style: getMediumStyle(fontSize: 14.sp,color: AppColors.grey,),maxLines: 2,textAlign: TextAlign.center,),

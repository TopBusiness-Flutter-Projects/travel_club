      ...
      children: [
        SizedBox(
          ...
          child: Checkbox(
            ...
            side: BorderSide(
                color: AppColors.secondPrimary.withOpacity(.5), width: 1.w),
            checkColor: AppColors.white,
            // Color of the tick
            fillColor: MaterialStateProperty.resolveWith((states) {
              if (states.contains(MaterialState.selected)) {
                return AppColors
                    .primary; // Primary color when checkbox is selected
              } else {
                return AppColors.white
                    .withOpacity(0.6); // Less opacity when not selected
              }
            }),
          ),
        ),
...
class CustomFacilitesCheckbox extends StatefulWidget {
  ...
  @override
  State<CustomFacilitesCheckbox> createState() =>
      _CustomFacilitesCheckboxState();
}

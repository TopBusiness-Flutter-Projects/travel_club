                  ...
                  Column(
                    ...
                    children: [
                      Row(
                        children: [
                          StarRating(
                              rating:double.tryParse(cubit.getRestaurantDetailsModel?.data?.rate.toString()??'0')??0,
                              size: 14.sp,
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                           ' ${cubit.getRestaurantDetailsModel?.data?.users.toString()}' + AppTranslations.personRateCompany,

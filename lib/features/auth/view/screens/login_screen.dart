               ...
               child: Column(
                 ...
                 children: [
                  ...
                  // CustomContainer(),
                   ...
                   CustomTextField(controller: cubit.passwordControllerLogin,enabled:true,isPassword: true,title: AppTranslations.pass,hintText: AppTranslations.writePass,),
                   ...
                   Row(
                     ...
                     children: [
                       Text(AppTranslations.havenotAccount,style: getSemiBoldStyle(color: AppColors.secondPrimary,fontSize: 14.sp),),
                       SizedBox(width: 7.w,),
                       InkWell(
                         onTap: (){
                           Navigator.pushNamed(context, Routes.signUp);
                         },
                           child: Text(AppTranslations.createNewAccount,style: getUnderLine(fontSize: 14.sp,color: AppColors.primary,fontweight: FontWeight.w500,),)),
                   ],)
